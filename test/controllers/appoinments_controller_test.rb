...
class AppoinmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create appoinment" do
    assert_difference('Appoinment.count') do
      post appoinments_url, params: { appoinment: { day: @appoinment.day, service_id: @appoinment.service_id, user_id: @appoinment.user_id } }
    end
  ...
  test "should update appoinment" do
    patch appoinment_url(@appoinment), params: { appoinment: { day: @appoinment.day, service_id: @appoinment.service_id, user_id: @appoinment.user_id } }
